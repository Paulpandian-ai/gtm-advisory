...
export const FALLBACK_BENCHMARKS: FallbackMetric[] = [
  ...
  // ── STAGE: Series A ────────────────────────────────────
  m("STAGE", "Series A", "winRate", 0.18, 0.22, 0.30, 0.23, 145, "ratio"),
  m("STAGE", "Series A", "salesCycleLength", 28, 38, 55, 40, 145, "days"),
  m("STAGE", "Series A", "cac", 12000, 20000, 35000, 22000, 138, "USD"),
  m("STAGE", "Series A", "ltvCacRatio", 2.0, 3.0, 5.0, 3.3, 138, "ratio"),
  m("STAGE", "Series A", "nrr", 0.95, 1.05, 1.15, 1.05, 130, "ratio"),
  m("STAGE", "Series A", "churnRate", 0.015, 0.03, 0.05, 0.033, 130, "ratio"),
  m("STAGE", "Series A", "magicNumber", 0.5, 0.7, 1.0, 0.73, 110, "ratio"),
  m("STAGE", "Series A", "paybackMonths", 14, 20, 28, 21, 110, "months"),
  m("STAGE", "Series A", "avgContractValue", 5000, 15000, 35000, 18000, 140, "USD"),
  m("STAGE", "Series A", "partnerSourcedRevenuePct", 0.03, 0.08, 0.15, 0.09, 100, "ratio"),
  m("STAGE", "Series A", "integrationCount", 8, 15, 30, 18, 100, "count"),

  // ── STAGE: Series B ────────────────────────────────────
  m("STAGE", "Series B", "winRate", 0.20, 0.26, 0.35, 0.27, 120, "ratio"),
  m("STAGE", "Series B", "salesCycleLength", 35, 48, 72, 52, 120, "days"),
  m("STAGE", "Series B", "cac", 18000, 30000, 50000, 33000, 115, "USD"),
  m("STAGE", "Series B", "ltvCacRatio", 2.5, 3.5, 6.0, 4.0, 115, "ratio"),
  m("STAGE", "Series B", "nrr", 1.00, 1.10, 1.20, 1.10, 112, "ratio"),
  m("STAGE", "Series B", "churnRate", 0.01, 0.025, 0.04, 0.025, 112, "ratio"),
  m("STAGE", "Series B", "magicNumber", 0.6, 0.8, 1.2, 0.87, 100, "ratio"),
  m("STAGE", "Series B", "paybackMonths", 12, 18, 24, 18, 100, "months"),
  m("STAGE", "Series B", "avgContractValue", 12000, 30000, 65000, 36000, 115, "USD"),
  m("STAGE", "Series B", "partnerSourcedRevenuePct", 0.08, 0.15, 0.25, 0.16, 90, "ratio"),
  m("STAGE", "Series B", "integrationCount", 20, 40, 70, 43, 90, "count"),

  // ── STAGE: Series C ────────────────────────────────────
  m("STAGE", "Series C", "winRate", 0.22, 0.28, 0.38, 0.29, 90, "ratio"),
  m("STAGE", "Series C", "salesCycleLength", 45, 65, 90, 67, 90, "days"),
  m("STAGE", "Series C", "cac", 25000, 42000, 70000, 46000, 88, "USD"),
  m("STAGE", "Series C", "ltvCacRatio", 3.0, 4.0, 7.0, 4.7, 88, "ratio"),
  m("STAGE", "Series C", "nrr", 1.05, 1.15, 1.25, 1.15, 85, "ratio"),
  m("STAGE", "Series C", "churnRate", 0.008, 0.02, 0.035, 0.021, 85, "ratio"),
  m("STAGE", "Series C", "magicNumber", 0.7, 0.9, 1.3, 0.97, 75, "ratio"),
  m("STAGE", "Series C", "paybackMonths", 10, 15, 22, 16, 75, "months"),
  m("STAGE", "Series C", "avgContractValue", 25000, 55000, 110000, 63000, 85, "USD"),
  m("STAGE", "Series C", "partnerSourcedRevenuePct", 0.12, 0.22, 0.35, 0.23, 70, "ratio"),
  m("STAGE", "Series C", "integrationCount", 40, 75, 120, 78, 70, "count"),
